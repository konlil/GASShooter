...
%UE4_ENGINE_PATH%\Engine\Binaries\Win64\UE4Editor-Cmd.exe "%PROJECT_PATH%\GASShooter.uproject" -run=MySingleCookerCommandlet -config="%PROJECT_PATH%\CookSingle.txt"
